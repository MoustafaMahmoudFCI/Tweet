<div class="border border-blue-400 rounded-xl py-2 px-8">
    ...
    {{-- <form method="POST" action="{{ route('tweets.store') }}"> --}}
        ...
        <footer class="flex justify-between my-2">
            ...
            <button type="submit" class="bg-blue-500 hover:bg-blue-600 py-2 transition duration-300 ease-in-out rounded-full px-10 text-white shadow">tweet</button>
        </footer>
    </form>
</div>
